...
if __name__ == "__main__":
    ...
    payment_credit = monthly_payment(principal, annual_rate, years, decimal_places = 6)

    print(f"\nFor a ${principal:,.2f} loan at {annual_rate:.3f}% for {years} years:")
    print(f"Monthly payment- mortgage method (2 decimal places): ${payment_mortgage:,.2f}")
    print(f"Monthly payment -credit card method (6 decimal places): ${payment_credit:,.2f}")
